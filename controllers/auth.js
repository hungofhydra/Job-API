...
const register = async (req, res) => {
  ...
  res
    ...
    .json({
      ...
      user: { name: user.name, mail: user.email },
      token,
    });
};
...
const login = async (req, res) => {
  ...
  res
    ...
    .json({ msg: "Logined successfully", user: { name: user.name }, token });
};
...
const forgotPassword = async (req, res) => {
  ...
  res
    .status(StatusCodes.OK)
    .json({ msg: "Sent password request to email successfully" });
};
...
const resetPassword = async (req, res) => {
  ...
  res
    .status(StatusCodes.OK)
    .json({
      msg: "Reseted password successfully. Email with new password has been sent to your email",
      newPassword,
    });
};
